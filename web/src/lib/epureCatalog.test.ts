...
test('plate numbers come from the caption, not the figure index', () => {
  ...
  assert.deepEqual(
    ...
    ['E 61 (a)', 'E 61 (b)', 'E 61 (c)', 'E 61 (d)', 'E 62', 'E 63', 'E 64', 'E 65', 'E 66', 'E 67', 'E 68', 'E 69', 'E 70', 'E 71', 'E 72', 'E 73', 'E 74', 'E 75', 'E 76', 'E 77', 'fig 20', 'fig 29 (b)', 'fig 30', 'fig 31', 'fig 33', 'E 90', 'E 90', 'fig 43', 'fig 44', 'E 93', 'E 94', 'E 95', 'E 96', 'E 97', 'E 98', 'E 99', 'E 100', 'E 102', 'E 103', 'E 104', 'E 104', 'fig 62'],
  );
});
...
test('the catalog binds to the exact book, and answers before any OCR', () => {
  ...
  assert.equal(epureFiguresFor(doc()).length, 42);
